...
function initializeSheets() {
  ...
  const sheetsConfig = {
    ...
    'ledger': ["ID", "DATE", "ACCOUNT_PI", "TYPE", "INWARD_TARGET_KG", "OUTWARD_DELIVERED_KG", "RATE", "VALUE_AMOUNT", "BALANCE_KG", "BALANCE_AMOUNT", "REMARKS"],
    'archive_pi': ["PI_NO", "INVOICE_DATE", "SELLER_NAME", "SELLER_GSTIN", "SELLER_CIN", "CERT_NO", "CUSTOMER_NAME", "CUSTOMER_ADDRESS", "CUSTOMER_GST_NO", "DELIVERY_NAME", "DELIVERY_ADDRESS", "DELIVERY_GST_NO", "HSN_CODE", "PRODUCT_QUALITY", "UNIT_COUNT", "QUANTITY_KG", "RATE_PER_UNIT", "ITEM_TOTAL", "NET_AMOUNT", "AUTHORIZED_SIGNATORY", "STATUS", "CREATED_AT", "ITEMS", "PAYMENT_TERMS", "NOTE", "TRANSPORT_MODE", "IGST_PERCENT", "ARCHIVED_AT", "PDF_URL", "PDF_DOWNLOAD_URL", "PDF_ID"],
